        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-header bg-primary text-white py-3">
                    <h4 class="mb-0"><i class="fas fa-comment-dots me-2"></i>Edit Testimoni</h4>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('admin.testimonial.update', $testimonial) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="user_name" value="{{ old('user_name', $testimonial->user_name) }}" class="form-control @error('user_name') is-invalid @enderror" required>
                            @error('user_name')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="message" rows="5" class="form-control @error('message') is-invalid @enderror" required>{{ old('message', $testimonial->message) }}</textarea>
                            @error('message')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
